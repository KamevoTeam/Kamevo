	...
	public function printPosts($mode){
		...
		<?php }else{ 
			...
			<div class="block">
				...
				<?php } }?>
	 			<div class="abouts">
	  				<img onclick="userVote(1,<?=$resp['ID'] ?>)" src="img/poucevert.png" alt="like" height="20" weight="20" class="like likes"/> <span class="nblikesid<?=$resp['ID'] ?>" id="nblikesid<?=$resp['ID'] ?>"><?=$resp['likes']; ?></span>
	  				<img onclick="userVote(2,<?=$resp['ID'] ?>)" src="img/poucerouge.png" alt="like" height="20" weight="20" class="like dislikes"/> <span class="nbdislikesid<?=$resp['ID'] ?>" id="nbdislikesid<?=$resp['ID'] ?>"><?=$resp['dislikes']; ?></span> <span class="infoLike"><progress id="avancement" class="avancementid<?=$resp['ID'] ?> progress-one" value="<?=$calculPourcent; ?>" max="100"></progress></span>

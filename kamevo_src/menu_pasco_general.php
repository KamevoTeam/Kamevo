	 ...
	 <nav class="menu" id="top">
	  <ul>
	    ...
	    <a href="#"><li class="title"> KAMEVO</li></a>
	     <div class="mme"><!-- No exploration , except on home page -->
	        <a class="js" href="index.php?mode=ins"><li class="link"><i class="fa fa-user-plus" id="icon"></i> Inscription</li></a>
	         <a class="js" href="index.php?mode=co"><li class="link"><i class="fa fa-sign-in" id="icon"></i> Connexion</li></a>

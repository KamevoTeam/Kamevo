...
<body>
	<?php if (isset($errro)) { if ($error == '*') { echo '<p><h1>Vous devez remplir <strong>TOUT</strong> le formulaire</h1></p>'; }} ?>
	<form method='POST' action='.' enctype="multipart/form-data">
		...
		<p><label for='mail'>Adresse Mail* : <input type='email' placeholder='ex@mple.com' name='mail' id='mail' required /><?php if (isset($error)) { if ($error == 'mail') { echo 'Ce mail est déjà utilisée'; }} ?></label></p>
